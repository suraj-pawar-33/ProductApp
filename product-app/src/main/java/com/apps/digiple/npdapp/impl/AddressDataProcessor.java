...
import com.apps.digiple.npdapp.executer.AppExecuter;
...
public class AddressDataProcessor {
	private static final Logger LOGGER = Logger.getLogger(AddressDataProcessor.class);
	protected AddressDataEditPanel editPanel;
	
	public AddressDataProcessor(AddressDataEditPanel editPanel) {
