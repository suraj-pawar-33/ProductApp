...
public class OrderModel extends ItemModel{
	...
	public static final String SUBMONTH = "subscrMonth";
	...
	private SimpleStringProperty subscrMonth;
	...
	public OrderModel(int orderKey, String localDate, int billNumber, String bankname, int totalAmount, String status) {
		...
		this.subscrMonth = new SimpleStringProperty(localDate);
	}
	...
	public String getSubscrMonth() {
		return subscrMonth.get();
	}
	...
	public void setSubscrMonth(String subscrMonth) {
		this.subscrMonth.set(subscrMonth);
	}
