...
public class TablePanel extends GridPane {
	...
	public TablePanel(EventHandler<MouseEvent> eventHandler, TableView<? extends ItemModel> tableView) {
		...
		this.printBtn = createPrintBtn(eventHandler);
	...
	private Button createPrintBtn(EventHandler<MouseEvent> eventHandler) {
		Button button = CustButton.getCustButton("", "PrintBtn");
